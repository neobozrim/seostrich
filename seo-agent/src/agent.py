        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "site_description": {"type": "string", "default": "", "description": "The user's site URL"},
                    "own_urls": {"type": "array", "items": {"type": "string"}, "description": "The user's OWN other pages: blog, docs, newsletter. Read for seeds; never treated as competitors."},
                    "competitor_urls": {"type": "array", "items": {"type": "string"}, "description": "Competitor URLs, up to 10, exactly as the user gave them"},
                },
