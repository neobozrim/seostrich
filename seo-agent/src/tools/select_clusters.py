...
1b. NOT A PRODUCT THE BUSINESS DOES NOT OWN. A cluster whose head term or most keywords name a specific third-party product, platform, vendor, course provider or model (n8n, Zapier, Coursera, Pendo, GPT-4, Claude...) is navigational for THAT product. Park it with the reason "product-navigational: <name> — belongs as a mention inside a topic piece, not as a pillar", unless the brief says the business IS about that product (its own product, or a stated focus such as "we are n8n partners"). A topic the product solves (workflow automation, evals, local models) can be a pillar; the product name cannot lead it.
