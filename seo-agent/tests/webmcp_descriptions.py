...
SRC = Path(str(Path(__file__).resolve().parent.parent / "ui" / "lib" / "webmcp.ts")).read_text(encoding="utf-8")
...
SPENDS = {"seo_propose_cluster", "seo_rerun_cluster_research", "seo_research_competitor", "seo_research_keyword"}
